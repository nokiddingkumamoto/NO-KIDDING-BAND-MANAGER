const CACHE = "no-kidding-band-manager-v9.0.6-public";
const ASSETS = [
  "./", "./index.html", "./pixel.css?v=9.0.6", "./shared.css?v=9.0.6",
  "./api.js?v=9.0.6", "./app.js?v=9.0.6", "./manifest.webmanifest",
  "./logo.png", "./top-page.png", "./icon.svg",
  "./studio.html", "./studio.css?v=9.0.6", "./studio.js?v=9.0.6",
  "./schedule.html", "./schedule.css?v=9.0.6", "./schedule.js?v=9.0.6",
  "./merch.html", "./merch.css?v=9.0.6", "./merch.js?v=9.0.6",
