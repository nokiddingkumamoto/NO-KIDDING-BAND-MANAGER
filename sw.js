const CACHE = "no-kidding-band-manager-v9.1.2-public";
const ASSETS = [
  "./", "./index.html", "./pixel.css?v=9.1.2", "./shared.css?v=9.1.2",
  "./api.js?v=9.1.2", "./app.js?v=9.1.2", "./manifest.webmanifest",
  "./logo.png", "./top-page.png", "./icon.svg",
  "./studio.html", "./studio.css?v=9.1.2", "./studio.js?v=9.1.2",
  "./schedule.html", "./schedule.css?v=9.1.2", "./schedule.js?v=9.1.2",
  "./merch.html", "./merch.css?v=9.1.2", "./merch.js?v=9.1.2",
